package com.protobuf
{
   ...
   public class CodedInputStream
   {
      ...
      {
         switch(int(WireFormat.getTagWireType(param1)))
         {
            case 0:
      ...
      public function readInt64() : Number
      {
         ...
         var _loc4_:int = 0;
         var _loc7_:int = 0;
         var _loc6_:Number = input.readUnsignedByte();
         var _loc9_:int = 0;
         var _loc8_:Array = [];
         while(_loc6_ >= 128)
         {
         ...
         if(_loc8_.length == 10)
         {
            ...
            var _loc10_:* = _loc8_;
            var _loc11_:* = 0;
            var _loc12_:* = Number(_loc10_[_loc11_]) - 1;
            ...
            while(_loc8_[_loc2_] < 0)
            {
               ...
               _loc10_ = _loc8_;
               _loc11_ = _loc2_ + 1;
               _loc12_ = Number(_loc10_[_loc11_]) - 1;
               _loc10_[_loc11_] = _loc12_;
            }
            _loc4_ = 0;
         ...
         {
            _loc1_ = Number(_loc1_ + _loc8_[_loc7_] * _loc3_);
            _loc3_ = Number(_loc3_ * 128);
            _loc7_++;
         }
      ...
      public function readRawVarint32() : int
      {
         ...
         if(readRawByte() >= 0)
         {
            _loc1_ = _loc1_ | _loc2_ << 7;
         }
         else
         {
            _loc1_ = _loc1_ | (_loc2_ & 127) << 7;
            _loc2_ = readRawByte();
            if(readRawByte() >= 0)
            {
               _loc1_ = _loc1_ | _loc2_ << 14;
            }
            else
            {
               _loc1_ = _loc1_ | (_loc2_ & 127) << 14;
               _loc2_ = readRawByte();
               if(readRawByte() >= 0)
               {
                  _loc1_ = _loc1_ | _loc2_ << 21;
               }
               else
               {
                  _loc1_ = _loc1_ | (_loc2_ & 127) << 21;
                  _loc2_ = readRawByte();
                  _loc1_ = _loc1_ | readRawByte() << 28;
                  if(_loc2_ < 0)
                  {
                     _loc3_ = 0;
                     while(_loc3_ < 5)
